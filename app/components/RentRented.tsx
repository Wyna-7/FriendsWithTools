...
const RentRented = () => {
  ...
  useEffect(() => {
    const ownerId = '1dff0d72-83fa-47bc-a6f3-82b0bcccfce5'; // Replace with the actual ownerId
    const userId = '1dff0d72-83fa-47bc-a6f3-82b0bcccfce5'; // Replace with the actual userId
